...
void getPSNR(Mat& Marked_Img)
{
	...
	Original = imread("C:/Users/fnzld/Desktop/Test_WM/land.png");
...
void getNCC()
{
	...
	while (cnt < 3)
	{
		Original_QRcode = imread("C:/Users/fnzld/Desktop/Test_WM/result/Original_QRCODE.png");
		//Extracted_QRcode = imread("C:/Users/fnzld/Desktop/Test_WM/result/HL_QRcode.png");
		if(cnt == 0)
			Extracted_QRcode = imread("C:/Users/fnzld/Desktop/Test_WM/result/HH_QRcode.png");
		else if (cnt == 1)
			Extracted_QRcode = imread("C:/Users/fnzld/Desktop/Test_WM/result/HL_QRcode.png");
		else if (cnt == 2)
			Extracted_QRcode = imread("C:/Users/fnzld/Desktop/Test_WM/result/LH_QRcode.png");
